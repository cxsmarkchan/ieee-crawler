...
class TestCitationLoader(TestCase):
    ...
    def test_get_citations_html(self):
        ...
        test_text = '\r\n'.join([
            ...
            '<br>  keywords={invertors;load flow;photovoltaic power systems;power distribution planning;power factor;power generation planning;power system management;reactive power;smart power grids;PV inverter system;apparent power feed-in;distribution grid;grid loss;grid planning;grid voltage;low voltage grid measurement data;overload problem;photovoltaic inverter;power factor specification of one;power grid;power system management;smart grid;unintended reactive power flow;voltage problem;Inverters;Load modeling;Low voltage;Power measurement;Reactive power;Solar power generation;Distributed power generation;inverters;photovoltaic (PV) systems;power system measurements;power system reliability;reactive power;smart grids;solar power generation;voltage control},',
    ...
    def test_get_bibtex(self):
        ...
        benchmark = [{
            ...
            'keyword': 'invertors;load flow;photovoltaic power systems;power distribution planning;power factor;power generation planning;power system management;reactive power;smart power grids;PV inverter system;apparent power feed-in;distribution grid;grid loss;grid planning;grid voltage;low voltage grid measurement data;overload problem;photovoltaic inverter;power factor specification of one;power grid;power system management;smart grid;unintended reactive power flow;voltage problem;Inverters;Load modeling;Low voltage;Power measurement;Reactive power;Solar power generation;Distributed power generation;inverters;photovoltaic (PV) systems;power system measurements;power system reliability;reactive power;smart grids;solar power generation;voltage control',
